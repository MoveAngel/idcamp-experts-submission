...
describe('a RegisterUser entities', () => {
  it('must result in error if payload did not contain needed property', () => {
    const payload = {
      username: 'abc',
      password: 'abc',
    };
  ...
  it('must result in error if payload did not meet data type specification', () => {
    const payload = {
      username: 123,
      fullname: true,
      password: 'abc',
  ...
  it('must result in error if username contains more than 50 character', () => {
    const payload = {
  ...
  it('must result in error if username contains restricted character', () => {
    const payload = {
      username: 'dico ding',
      fullname: 'dicoding',
      password: 'abc',
  ...
  it('must instantiate registerUser object properly', () => {
    const payload = {
      username: 'dicoding',
      fullname: 'Dicoding Indonesia',
      password: 'abc',
